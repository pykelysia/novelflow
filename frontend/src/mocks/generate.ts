import type { ChapterResult, GenerateStatusResponse, TaskItem } from "../api/types";
...
export function getMockStatus(sessionId: string): GenerateStatusResponse {
  return {
